...
function AdminDashboard() {
  ...
  const loadStats = async () => {
      try {
          const res = await axios.get('https://hostel-library-book-management-1.onrender.com/api/transactions/report');
  ...
  const fetchAllData = async () => {
      try {
          const resStudents = await axios.get('https://hostel-library-book-management-1.onrender.com/api/auth/all-students');
          setAllStudents(resStudents.data);
          
          const resAdmins = await axios.get('https://hostel-library-book-management-1.onrender.com/api/auth/all-admins');
          setAllAdmins(resAdmins.data);

          const resTrans = await axios.get('https://hostel-library-book-management-1.onrender.com/api/transactions/all-history');
          ...
          const resBooks = await axios.get('https://hostel-library-book-management-1.onrender.com/api/books/search?q=');
  ...
  const handleCreateAdmin = async () => {
      ...
      try {
          await axios.post('https://hostel-library-book-management-1.onrender.com/api/auth/create-admin', newAdmin);
  ...
  const handleDeleteUser = async (id, type) => {
      if(window.confirm(`Are you sure you want to delete this ${type}?`)) {
          try {
              await axios.delete(`https://hostel-library-book-management-1.onrender.com/api/auth/delete/${id}`);
              alert(`${type} Deleted`);
              fetchAllData(); 
  ...
  const handleIssue = async () => {
    ...
    try {
        const res = await axios.post('https://hostel-library-book-management-1.onrender.com/api/transactions/issue-direct', issueData);
  ...
  const handleReturn = async () => {
    setMessage({ type: '', text: '' });
    try {
        const res = await axios.post('https://hostel-library-book-management-1.onrender.com/api/transactions/return-direct', { accessionNumber: returnAccession });
  ...
  const handleAddBook = async () => {
    try {
      await axios.post('https://hostel-library-book-management-1.onrender.com/api/books/add', newBook);
      alert('Book Added!');
                  ...
                  <Paper sx={{ padding: '20px', backgroundColor: '#fff', borderRadius: '15px', boxShadow: 3 }}>
                      ...
                      <Box display="flex" gap={2}>
                          ...
                          <Button variant="contained" size="large" onClick={async () => {
                              try {
                                  const res = await axios.get(`https://hostel-library-book-management-1.onrender.com/api/auth/student/${studentSearch}`);
                                  setStudentResult(res.data);
                                  const resBooks = await axios.get(`https://hostel-library-book-management-1.onrender.com/api/transactions/student-active/${res.data._id}`);
              ...
              <Box sx={{ maxWidth: '900px', margin: '0 auto' }}>
                  ...
                  <Paper sx={{ padding: '30px', borderRadius: '15px', boxShadow: 3 }}>
                      ...
                      <Box display="flex" gap={2}>
                          ...
                          <Button variant="contained" size="large" onClick={async () => { 
                              try { 
                                  const res = await axios.get(`https://hostel-library-book-management-1.onrender.com/api/books/search?q=${bookQuery}`); 
